                ...
                if (index == dialogue.dialogNodes.Length)
                {
                    ...
                    switch (npcOnTalkingName)
                    {
                       case "柴犬":
                        ...
                        //柴犬的两个任务
                        if((GameObject.Find("柴犬").GetComponent<DialogueIndex>().dialogueIndex ==1&&GameObject.Find("柴犬").GetComponent<DataSaveManager>().isProteinEverbeenFound)||(GameObject.Find("柴犬").GetComponent<DialogueIndex>().dialogueIndex == 3 && GameObject.Find("DataSaveManager").GetComponent<DataSaveManager>().isFakeToothFind))
                        {
                            GameObject.Find("柴犬").GetComponent<DialogueIndex>().AddIndex();
                        }
                        break;

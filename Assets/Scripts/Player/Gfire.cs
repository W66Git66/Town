...
public class Gfire : MonoBehaviour
{
    ...
    Vector2 la = new Vector2(viewLerp, 50);//左下   
    Vector2 lb = new Vector2(viewLerp, Screen.height - 50f);//左上
    Vector2 ra = new Vector2(Screen.width - viewLerp, 50);//右下
    Vector2 rb = new Vector2(Screen.width - viewLerp, Screen.height - 50f);//右上
